...
def passive(benchmark, **kwargs):
  invoc_str = 'make arch=Linux_Serial CXX=clang++ INSTRUMENTATION="-finstrument-functions -finstrument-functions-whitelist-inputfile=/home/j_lehr/all_repos/gh-sachinmanawadi-pgoe/out/instrumented-test_run-hpcg30.txt"'
