...
python3 ../../../pira.py --config-version 2 --slurm-config ${testDir}/batchsystem.json --iterations 10 --repetitions 1 --lide --tape lulesh.tp --analysis-parameters $testDir/parameters.json $testDir/lulesh_config.json
