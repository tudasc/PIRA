...
python3 ../../../../pira.py --config-version 2 --extrap-dir ${pira_dir}/piraII --extrap-prefix t --tape ../gol.tp --slurm-config $testDir/batchsystem.json --analysis-parameters $testDir/parameters.json $testDir/gol_config.json
pirafailed=$?
cd $testDir
